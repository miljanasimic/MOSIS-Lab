...
class ListFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val mListView : ListView = requireView().findViewById<ListView>(R.id.my_places_list)
        val arrayAdapter : ArrayAdapter<MyPlace> = ArrayAdapter<MyPlace>(view.context,
        ...
        mListView.setOnCreateContextMenuListener(object : View.OnCreateContextMenuListener{
